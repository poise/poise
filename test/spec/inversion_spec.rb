...
describe Poise::Inversion do
  describe Poise::Inversion::Resource do
    ...
    describe '#provider' do
      ...
      context 'with a symbol provider' do
        ...
        before do
          expect(Poise::Inversion).to receive(:provider_for).with(:poise_test_inversion, nil, :invert).and_return(sentinel)
      ...
      context 'with a symbol that is not a provider' do
        before do
          expect(Poise::Inversion).to receive(:provider_for).and_return(nil)
  ...
  end # /decribe Poise::Inversion::Resource

  describe Poise::Inversion::Provider do
    ...
    provider(:poise_test_inversion) do
      include Poise::Inversion::Provider
  ...
  end # /describe Poise::Inversion::Provider
end
